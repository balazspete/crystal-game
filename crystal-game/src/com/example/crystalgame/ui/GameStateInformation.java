...
public class GameStateInformation {
	...
	public GameStateInformation() {
		...
		characterList.add(new Wizard(53.34363338800144 ,-6.2468171864748, PlayerType.PLAYER)); 
		characterList.add(new Warrior(53.34374948335228 ,-6.246790029108524, PlayerType.PLAYER));
	}
